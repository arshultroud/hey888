...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await idk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await idk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await idk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await ydk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await ydk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await ydk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await wdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await wdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await wdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await hdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await hdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await hdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await sdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await sdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await sdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await adk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await adk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await adk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await bdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await bdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await bdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await cdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await cdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await cdk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await ddk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await ddk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await ddk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await edk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await edk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await edk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await vkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await vkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await vkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await kkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await kkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await kkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await lkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await lkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await lkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await mkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await mkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await mkk(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await sid(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await sid(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await sid(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await shy(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await shy(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await shy(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await aan(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await aan(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await aan(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await ake(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await ake(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await ake(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await eel(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await eel(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await eel(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await khu(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await khu(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await khu(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await shi(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await shi(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await shi(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await yaa(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await yaa(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await yaa(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await dav(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await dav(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await dav(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await raj(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await raj(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await raj(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await put(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await put(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            await put(functions.channels.JoinChannelRequest(channel="@sub4sub_for_youtubers"))
            botid = telethon.utils.get_peer_id(botme)
...
@idk.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@ydk.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@wdk.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@hdk.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@sdk.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@adk.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@bdk.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@cdk.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@edk.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@ddk.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@vkk.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@kkk.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@lkk.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@mkk.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@sid.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@shy.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@aan.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@ake.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@eel.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@khu.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@shi.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@yaa.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@dav.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@raj.on(events.NewMessage(incoming=True, pattern=r"\+fake"))
@put.on(events.NewMessage(incoming=True, pattern=r"\+fake"))

async def spam(e):
    usage = "𝗠𝗼𝗱𝘂𝗹𝗲 𝗡𝗮𝗺𝗲 = 𝗗𝗲𝗹𝗮𝘆𝗦𝗽𝗮𝗺\n\nCommand:\n\n.fake <sleep time> <count> <message to spam>\n\n.fake <sleep time> <count> <reply to a message>\n\nCount and Sleeptime must be a integer."
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        smex = await e.get_reply_message()
...
💥💥CONGRATULATIONS UR BOT= SPAM BOT IS READY💥💥💥
💥💥💥💥💥💥 ARSH 💥💥💥💥💥💥"""
